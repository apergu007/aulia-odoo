...
class StockInventory(models.Model):
    ...
    state = fields.Selection(string='Status', selection=[
        ...
        default='draft')
    type_adjustments = fields.Selection(
        selection=[('qty_only', 'Quantity Only'), ('value_only', 'Value Only'), ('normal', 'Normal')], string="Inventory Type", default="normal", required=True)
    ...
    line_value_ids = fields.One2many(
        'stock.inventory.line.value', 'inventory_id', string='Inventories Value', copy=False)
    ...
    def action_send_for_approval(self):
        ...
        has_group = self.env.ref('bmo_inventory_stock_adjustments.group_stock_adjustments_manager')
    ...
    def action_export_stock_adjustment(self):
        return {
            ...
            'view_mode': 'form',
            'view_id': self.env.ref("bmo_inventory_stock_adjustments.stock_adjustment_report_export_view_form").id,
